                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="ns2" value="{(!empty($nameServer['ns2']))? {$nameServer['ns2']}: ''}" />
                            </div>
                        </div>
                        <input type="submit" name="changeNS" class="btn btn-success" value="{$MGLANG->T('changeNameServer')}" />  
                    </form>
                </div>
            </div>
        </div>
