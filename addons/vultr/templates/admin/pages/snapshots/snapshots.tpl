            ...
            <table class="table  table-hover">
                ...
                <tbody>
                    {foreach from=$snapshotList item=e}
                        <tr>
                            <td>{$e['SNAPSHOTID']}</td>
                            <td>{if !empty($e['client'])}<a href="clientssummary.php?userid={$e['client']['clientid']}">{$e['client']['clientname']}</a> {/if}</td>
                            ...
                            <td>
                                <div class="onoffswitch onoffswitch-{$e['SNAPSHOTID']}">
                                    <input type="checkbox" name="{$e['SNAPSHOTID']}" class="onoffswitch-checkbox" id="{$e['SNAPSHOTID']}" value="{$e['SNAPSHOTID']}" {if !empty($allowSnapshots[$e['SNAPSHOTID']])}checked{/if}>
