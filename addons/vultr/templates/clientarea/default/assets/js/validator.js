...
+function ($) {
  ...
  var inputSelector = ':input:not([type="submit"], button,[data-no-validate]):enabled:visible'
...
//    if($el.data('no-validate') !== undefined) { //$el.data('no-validate') !== undefined || 
//        return ;
//    }
  ...
  Validator.prototype.runValidators = function ($el) {
    ...
    if(!$el.is(inputSelector)) { //$el.data('no-validate') !== undefined || 
