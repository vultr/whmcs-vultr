...
<div class="row" id="vultrSNAPSHOTContainer">
    <div class="panel panel-default">
        ...
        <div class="row">
            <p></p>
            <form action="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=Snapshots&cloudAction=add" method="POST">
                ...
                <div class="form-group col-sm-10 col-sm-offset-1">
                    <button type="submit" name="vultrAddAction" class="btn btn-default">{$_LANG.snapshots.add.create}</button>
                </div>                
            </form>
        </div>
    </div>
