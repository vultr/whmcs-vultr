...
<div class="row" id="vultrMAINContainer">
    <div class="panel panel-default">
        ...
        <form class="form-horizontal" role="form" action="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=Main&cloudAction=create" method="POST">
            <!--Select Label-->
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <button type="submit" name="cloudCreateAction" class="btn btn-default">{$_LANG.main.create.create}</button>
                </div>
            </div>
            <!--Submit END-->     
        </form>
