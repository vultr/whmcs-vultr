        ...
        <table class="table table-striped table-bordered">
            ...
            {foreach from=$backups item=backup}
                <tr>
                    ...
                    <td>
                        <a onclick="return confirm('{$_LANG.backups.index.confirm}')" class="btn btn-danger" type="button" href="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=Backups&cloudAction=restore&vultrID={$backup['BACKUPID']}">{$_LANG.backups.index.restore}</a>
                    </td>
                </tr>
            {foreachelse}
                <tr>
