...
<div class="row" id="vultrDNSContainer">
    <div class="panel panel-default col-sm-12">
        <form action="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=Dns&cloudAction=create" method="POST">
            ...
            <div class="row">
                {if count($domains)>0}
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input type="text" class="form-control" id="vultrDNSdomainName" name="vultrDNSdomainName" value="{if isset($postData.vultrDNSdomainName)}{$postData.vultrDNSdomainName}{/if}" placeholder="example.com">
                    </div>
                {else}
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control text-center" id="vultrDNSserverIP" name="vultrDNSserverIP" value="{if isset($postData.vultrDNSserverIP)}{$postData.vultrDNSserverIP}{else}{$ip}{/if}">
                </div>
            </div>
