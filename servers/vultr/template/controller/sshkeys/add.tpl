...
<div class="row" id="vultrSSHContainer">
    <div class="panel panel-default">
        ...
        <div class="row">
            <form id="addSSHKeyForm" action="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=SSHKeys&cloudAction=add" method="POST" class="col-sm-10 col-sm-offset-1">
                <div class="form-group col-sm-3">
                    <label for="vultrSSHKEYname">{$_LANG.sshkeys.add.name}</label>
                    <input type="text" class="form-control" id="vultrSSHKEYname" name="vultrSSHKEYname" placeholder="{$_LANG.sshkeys.add.script_name}">
                </div>
