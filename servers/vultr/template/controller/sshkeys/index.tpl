        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-sm-offset-2 col-sm-2">
                    <a class="btn btn-success" type="button" href="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=SSHKeys&cloudAction=add">{$_LANG.sshkeys.index.add}</a>
                </div>
            </div>            
        </div>
        <table class="table table-striped table-bordered">
            ...
            {foreach from=$keys item=script}
                <tr>
                    ...
                    <td><a onclick="return confirm('{$_LANG.sshkeys.index.confirm}')" class="btn btn-danger" type="button" href="{$WEB_ROOT}/clientarea.php?action=productdetails&id={$serviceid}&cloudController=SSHKeys&cloudAction=delete&vultrID={$script['SSHKEYID']}">{$_LANG.sshkeys.index.delete}</a></td>
                </tr>
            {foreachelse}
                <tr>
                    <td colspan="4">
